...
public class Aux_Enemy : MonoBehaviour {
    ...
    {            
        ...
        Enemy_Hp = Enemybug.GetComponent<Aux_EnemyHp>();
    ...
    {        
            EnemyTarget.GetComponent<Aux_TowerHP>().Dmg_2(Creature_Damage);       
    }
