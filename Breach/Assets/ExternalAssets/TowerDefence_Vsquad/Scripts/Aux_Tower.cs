...
public class Aux_Tower : MonoBehaviour {
    ...
    void Start()
    {
        ...
        TowerHp = Towerbug.GetComponent<Aux_TowerHP>();
    }
...

    {
        if (target)
        {
            target.GetComponent<Aux_EnemyHp>().Dmg(dmg);
        }
    }
	...
	IEnumerator shoot()
	{
        ...
        if (target && Catcher == false)
        {
            ...
            b.GetComponent<Aux_TowerBullet>().target = target;
            b.GetComponent<Aux_TowerBullet>().twr = this;
